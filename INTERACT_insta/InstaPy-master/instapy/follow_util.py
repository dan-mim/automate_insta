...
def get_following_status(
    ...
    follow_button_XP = "//button/div/div[text()='Following' or                                   text()='Requested' or                                   text()='Follow' or                                   text()='Follow Back' or                                   text()='Unblock' and not(ancestor::*/@role = 'presentation')]" #read_xpath(get_following_status.__name__, "follow_button_XP")
